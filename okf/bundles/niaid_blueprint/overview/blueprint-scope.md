...
title: The NIAID Blueprint for Digital Objects
...
| # | Concept | Lines |
|---|---------|-------|
| 12 | The Blueprint serves as a foundational starting point for NIAID data resources, providing a minimal set of specifications. | 55 |
| 13 | The Blueprint is not intended to fully meet the unique needs of each repository. | 55 |
| 14 | A primary goal of the NIAID Blueprint is to align NIAID resources under a shared framework. | 55 |
| 15 | A primary goal is to support prospective data capture for data generators and define structured elements that data repository owners should capture from their contributors. | 55 |
| 16 | A primary goal is to create a flexible framework that integrates with the broader NIAID ecosystem of digital objects, including the NIAID Data Ecosystem Discovery Portal. | 55 |
| 17 | The NIAID Blueprint is organized into five key areas. | 55 |
| 18 | Area 1—NIAID minimal metadata schema: required use of a minimal set of NIAID-relevant metadata elements and a standard schema with default formats to represent these metadata. | 59 |
| 19 | Area 2—Persistent Identifiers: use of PIDs for relevant metadata elements, e.g., for authenticated repository users or data generators (authors). | 60 |
