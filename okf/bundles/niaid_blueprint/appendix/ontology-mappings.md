...
title: Appendix — Ontology Mappings
...
| # | Concept | Lines |
|---|---------|-------|
| 214 | The Ontologies appendix provides a short list of ontologies relevant to the representation of metadata in biomedical research. | 372 |
| 215 | ImmPort provides a reference of 45 ontologies pertinent to immune-related infectious disease (IID) data. | 372 |
| 216 | The OBO Foundry offers a list of coordinated ontologies that focus on biomedical concerns. | 372 |
| 217 | BioPortal hosts a large, uncurated collection of community-contributed ontologies spanning biomedical and other research fields. | 372 |
| 218 | Supplemental Table 5 outlines the mapping of metadata elements to default and alternative ontologies. | 374-376 |
| 219 | measurementTechnique default ontology is NCIT; alternatives include BAO, OBI, and MMO. | 380-383 |
| 220 | license ontologies include SPDX (default), Open Digital Rights Language (ODRL), and Creative Commons. | 384-386 |
